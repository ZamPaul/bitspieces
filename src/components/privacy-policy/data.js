export const definitions = [
    ...
    "Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Bits & Pieces Event Organizing, Al Quoz 1st Industrial, Warehouse No. 9 PO Box 282747.",
...
export const LinkstoOtherWebsites = [
...
export const DisputesResolution = [
    "If You have any concerns or disputes about the Service, You agree to first try to resolve the dispute informally by contacting the Company."
]

export const EuropeanUnionUsers = [
    "If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in."
]

export const UnitedStatesLegalCompliance = [
    "You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a “terrorist supporting” country, and (ii) You are not listed on any United States government list of prohibited or restricted parties."
]

export const TranslationInterpretation = [
