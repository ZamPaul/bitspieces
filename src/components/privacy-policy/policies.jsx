...
const Policies = () => {
  return (
    <div className='policy-wrap relative w-full pt-[7vh] tab:pt-[5vh] mob:pt-[5vh] border-t-[1px] border-t-[var(--bor)] bg-black flex mob:flex-col justify-between items-start mob:gap-[20px]'>
      <Left/>
      <Right/>
    </div>
  )
    ...
    return (
        <div className="policy-right w-[55%] tab:w-[70%] mob:w-full flex flex-col items-start gap-[20px]">
            <div className="policy-group flex flex-col items-start gap-[15px]">
                <div className="title">
                    <h1 className='text-[#fff] text-[2.5vw] tab:text-[3vw] mob:text-[7vw] leading-[1.1em]'>
                        Interpretation and Definitions
                    </h1>
                </div>
                <div className="information mob:mt-[10px] flex flex-col items-start gap-[15px]">
                    <h2 className='text-[#fff] font-[900]'>
                        Interpretation:
                    </h2>
                    ...
                    <div className="definitions flex flex-col justify-start gap-[15px]">
                        ...
                        <p className='text-[#fffd]'>
                            "Terms and Conditions (also referred as “Terms”) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a className="para-link text-[#fff]" target="_blank" href='https://www.termsfeed.com/terms-conditions-generator/'> TermsFeed </a>Terms and Conditions Generator.
                        </p>
                        <p className='text-[#fffd]'>
                            Third-party Social Media Service means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service. Website refers to Bits & Pieces, accessible from <a target="_blank" href='http://www.bitspieces.org/' className='para-link text-[#fff]'>http://www.bitspieces.org/</a>
                        </p>
                        <p className='text-[#fffd]'>
