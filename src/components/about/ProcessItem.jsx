...
const ProcessItem = ({approach, count, key, description}) => {
  ...
  return (
    <div key={key} className='process-item py-[9vh] tab:py-[5vh] mob:py-[7vh] border-b-[1px] border-b-[var(--bor)] w-full flex mob:flex-col justify-between items-start mob:gap-[5vw]'>
